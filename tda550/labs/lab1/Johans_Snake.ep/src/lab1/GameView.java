...
public class GameView extends JComponent {
	...
	public void paintComponent(final Graphics g) {
		...
		if (this.model != null) {
			...
			/* 
			 * Draw the current score in the top left part of
			 * the canvas. Takes advantage of the abstract
			 * 'getScore' method declared in GameModel.java and
			 * implemented in SnakeModel.java.
			*/
			g.setColor(Color.BLACK);
			g.setFont(new Font("Sans", Font.BOLD, 14));
			
			String scoreString = (model.getScore() == 1) ? "point" : "points";
			g.drawString(model.getScore() + " " + scoreString, 10, 20);
