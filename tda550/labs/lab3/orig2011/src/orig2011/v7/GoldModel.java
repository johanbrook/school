...
public class GoldModel implements GameModel {
	...
	public GoldModel() {
		...
		//this.board = GameUtils.newBoard(size.width, size.height, BLANK_TILE);
		...
		//TODO board[collectorPos.getX()][collectorPos.getY()] = COLLECTOR_TILE;
	...
	private void addCoin() {
		...
		//TODO board[newCoinPos.getX()][newCoinPos.getY()] = COIN_TILE;
	...
	public void gameUpdate(final int lastKey) throws GameOverException {
		...
		//TODO board[collectorPos.getX()][collectorPos.getY()] = BLANK_TILE;
		...
		this.coins.remove(0);
		//TODO board[oldCoinPos.getX()][oldCoinPos.getY()] = BLANK_TILE;
		...
		changeSupport.firePropertyChange("gameUpdate", oldCoinPos, null);
	...
	private boolean isOutOfBounds(Position pos) {
		return pos.getX() < 0 || pos.getX() >= size.width
				|| pos.getY() < 0 || pos.getY() >= size.height;
	}
